...
#	@echo execute tests on older supported go versions
	GOTOOLCHAIN=go1.23.11 go1.23.11 test ./...
	GOTOOLCHAIN=go1.23.11 go1.23.11 test ./... -race
#	@echo execute tests on future supported go versions
	GOTOOLCHAIN=go1.25rc2 go1.25rc2 test ./...
	GOTOOLCHAIN=go1.25rc2 go1.25rc2 test ./... -race
