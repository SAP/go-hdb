...
func (id *ClientID) decode(dec *encoding.Decoder, prms *decodePrms) error {
	*id = resizeSlice(*id, prms.bufLen)
	dec.Bytes(*id)
	return dec.Error()
}
...
func (c *Command) decode(dec *encoding.Decoder, prms *decodePrms) error {
	*c = resizeSlice(*c, prms.bufLen)
	var err error
...
func (s *Fetchsize) decode(dec *encoding.Decoder, prms *decodePrms) error {
...
func (id *StatementID) decode(dec *encoding.Decoder, prms *decodePrms) error {
