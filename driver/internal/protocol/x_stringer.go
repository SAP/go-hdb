// Code generated by "stringer -type=TypeCode,MessageType,ClientContextOption,ConnectOption,DBConnectInfoType,DataType,FunctionCode,PartKind,Cdm,endianess,segmentKind,statementContextType,topologyOption,transactionFlagType,dpv,lobTypecode -output=x_stringer.go"; DO NOT EDIT.
