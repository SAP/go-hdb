// Code generated by "stringer -type=typeCode,MessageType,clientContextOption,connectOption,dbConnectInfoType,DataType,FunctionCode,PartKind,Cdm,endianness,segmentKind,statementContextType,topologyOption,ServiceType,transactionFlagType,dpv,lobTypecode -output=x_stringer.go"; DO NOT EDIT.
...
func _() {
	...
	_ = x[coEndianness-34]
	_ = x[coUpdateTopologyAnywhere-35]
...
const _connectOption_name = ""

var _connectOption_index = [...]uint16{0, 14, 38, 52, 81, 102, 123, 146, 169, 194, 226, 236, 255, 272, 298, 322, 347, 376, 396, 421, 444, 464, 501, 521, 536, 566, 585, 606, 636, 660, 685, 697, 705, 728, 740, 764, 781, 803, 823, 849, 884, 913, 947, 970, 989, 1003, 1018, 1046, 1081, 1107, 1139, 1167, 1195, 1205, 1227, 1238, 1251, 1268, 1284, 1300, 1314, 1328, 1342}
...
func (i endianness) String() string {
	idx := int(i) - 0
	if i < 0 || idx >= len(_endianness_index)-1 {
		return "endianness(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _endianness_name[_endianness_index[idx]:_endianness_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
func _() {
	...
	_ = x[tfReadOnlyMode-7]
	_ = x[tfLast-8]
}

const _transactionFlagType_name = "tfRolledbacktfCommittedtfNewIsolationLeveltfDDLCommitmodeChangedtfWriteTransactionStartedtfNowriteTransactionStartedtfSessionClosingTransactionErrortfReadOnlyModetfLast"

var _transactionFlagType_index = [...]uint8{0, 12, 23, 42, 64, 89, 116, 148, 162, 168}
